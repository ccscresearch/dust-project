...
Este repositório está organizado em uma estrutura de diretórios onde cada um representa uma linha de ações do projeto. A descrição dos diretórios é como segue:
 ...
 - [Interface gráfica](https://github.com/ccscresearch/dust-project/tree/main/interface) - Arquivos relacionados à interface gráfica de gerenciamento e exibição de resultados
...
<img src="https://github.com/ccscresearch/dust-project/blob/main/img/confMatCarlini3.png" alt="drawing" width="450" align="center"/>

<img src="https://github.com/ccscresearch/dust-project/blob/main/img/confMatFGSM3.png" alt="drawing" width="450" align="center"/>

Finalmente, a união das linhas de pesquisa considerando a detecção de um comportamento previamente modelado a partir de características específicas (tamanho do pacote, direção do pacote, informações temporais, etc) no tráfego de uma rede e a ofuscação desse comportamento a partir de amostras geras por modelos de aprendizagem adversários pode ser observada no resultado final. Na figura abaixo nota-se que o mesmo modelo que tinha a capacidade de reconhecer ataques com cerca de 99% de acurácia consegue aproximadamente 86% de acurácia com as amostras adversariais. A queda bruta na capacidade de reconhecimento do ataque é cerca de 13%, mas uma observação importante é que todas as amostras apresentadas no último teste são adversariais, ou seja, não existem informações provenientes de um conjunto de dados real. Sendo assim, nota-se que amostras adversárias podem ser empregadas com êxito para ofuscar um comportamento modelado através das características encontradas em um fluxo de dados de uma rede. Notamos que existem diferenças drásticas na eficiência das amostras adversariais dependendo do tipo de técnica empregada para gerar as amostras, do tipo de modelo que executa a detecção do comportamento, da quantidade de classes existente nos conjuntos de dados (multiclasses ou binária), entre outros fatores. 

<img src="https://github.com/ccscresearch/dust-project/blob/main/img/matrixConfusionAdv.png" alt="drawing" width="450" align="center"/>
