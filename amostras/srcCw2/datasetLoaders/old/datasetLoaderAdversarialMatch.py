...
class AdversarialDataSet():
    ...
    def preProcessDataset(self):
        ...
        for datasetNm in dataSetsName:
            ...
            tensorLabel = torch.load(self.labelsPath+datasetNm)               
            for register in tensor:                
                totalData.append(register)
            for register in tensorLabel:                
    ...
    def loadDataset(self, preProcessed):            
        ...
        save3DTensorAsStringFile(self.tensorDatabase,'../outputs/tensorDatabaseMatch')
        save2DTensorAsStringFile(self.labels,'../outputs/labelsMatch')
